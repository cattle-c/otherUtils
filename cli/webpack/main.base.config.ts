...
const mainBaseConfig = (webpackEnv: Configuration['mode'], userConfig: CliConfig['main']): Configuration => {
  ...
  return {
    ...
    entry: {
      main: paths.appMainEntry,
    },
    output: {
      path: isPrd ? paths.appMainBuild : paths.appMainDevCache,
      filename: '[name].js',
